    ...
    <>
      ...
      <div className="relative" ref={containerRef}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex gap-6 list-none p-0 m-0 relative z-[3]"
            style={{
              color: 'white',
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`gooey-nav-item rounded-full relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-black ${
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.6em] px-[1em] inline-block no-underline text-inherit"
                >
                  {item.label}
                </a>
              </li>
        ...
        <span className="gooey-nav-effect text" ref={textRef} />
      </div>
    </>
  );
};
